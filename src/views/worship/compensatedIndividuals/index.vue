  ...
  <div class="app-container">
    ...
    <div class="table">
      <div class="table-title-box">
        <div class="title-name">其他优抚对象列表</div>
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              :disabled="multiple"
              @click="handleExport('/worship/basicPerson/export', 1, '其他优抚对象列表')"
              >导出所选</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              plain
              size="mini"
              @click="handleExport('/worship/basicPerson/export', 2, '其他优抚对象列表')"
              >导出列表</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              plain
              size="mini"
              @click="handleExport('/worship/basicPerson/export', 3, '其他优抚对象列表')"
              >导出全部</el-button
            >
          </el-col>
          <!-- <el-col :span="1.5">
            <el-button
              plain
              size="mini"
              @click="handleExport('/worship/basicPerson/export', queryParams, '其他优抚对象')"
              >导出</el-button
            >
          </el-col> -->
          <el-col :span="1.5">
      ...
      <el-table v-loading="loading" :data="basicPersonList" @selection-change="handleSelectionChange" height="50vh">
        ...
        <el-table-column label="优抚类别" align="center" prop="phone">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button size="mini" type="text">
              <router-link :to="'/worship/compensatedIndividuals/info/' + scope.row.id" class="link-type">
                <el-button size="mini" type="text">详情</el-button>
              </router-link>
            </el-button>
            <el-button size="mini" type="text" @click="handleUpdate(scope.row)">修改</el-button>
            <el-button size="mini" type="text" @click="handleDelete(scope.row)">删除</el-button>
            <el-button size="mini" type="text" @click="handleTransfer(scope.row)">转区外</el-button>
          </template>
        </el-table-column>
      </el-table>
      <pagination
...
import {
  ...
  addBasicPerson,
  updateBasicPerson,
} from '@/api/worship/compensatedIndividuals.js';
