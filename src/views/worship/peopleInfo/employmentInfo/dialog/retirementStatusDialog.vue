  ...
  <div class="workInfoEditDialog">
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body @close="cancel">
      <el-form ref="form" :model="form.expandContent" :rules="rules" label-width="140px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="离退休前单位：" prop="">
              <el-input v-model="form.expandContent.preRetirementUnit"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="从事时间：" prop="">
              <el-date-picker
                v-model="form.expandContent.engagedInTime"
                type="date"
                placeholder="选择日期"
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="" prop="" label-width="0">
              <el-input v-model="form.expandContent.careerName"></el-input> </el-form-item
          ></el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
