  ...
  <div class="workInfoEditDialog">
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body @close="cancel">
      <el-form ref="form" :model="form.expandContent" :rules="rules" label-width="160px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="与军人关系：" prop="">
              <el-select v-model="form.expandContent.relationship">
                <el-option
        ...
        <el-row>
          <el-form-item label="" prop="" label-width="80px">
            <div class="title">病故军人情况</div>
          </el-form-item>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="姓名：" prop="">
              <el-input v-model="form.expandContent.nameSickSoldier"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="入伍日期：" prop="">
              <el-date-picker
                v-model="form.expandContent.dateEnlistment"
                type="date"
                placeholder="选择日期"
                value-format="yyyy-MM-dd"
              >
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="认定时间：" prop="">
              <el-date-picker
                v-model="form.expandContent.recognitionTime"
                type="date"
                placeholder="选择日期"
                value-format="yyyy-MM-dd"
              >
