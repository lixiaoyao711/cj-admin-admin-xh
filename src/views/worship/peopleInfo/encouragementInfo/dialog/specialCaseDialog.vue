      ...
      <el-form ref="form" :model="form.expandContent" :rules="rules" label-width="160px">
        <el-row>
          <el-form-item label="活动类型：" prop="">
            <el-select v-model="form.expandContent.activityType">
              <el-option
                v-for="item in dict.type.sys_worship_activity"
                :key="item.label"
                :label="item.label"
                :value="item.label"
              ></el-option>
        ...
        <el-row>
          <el-form-item label="邀请单位：" prop="">
            <el-input v-model="form.expandContent.invitationUnit"></el-input>
          </el-form-item>
        </el-row>
        <el-row>
          <el-form-item label="活动名称：" prop="">
            <el-input v-model="form.expandContent.activityName"></el-input>
          </el-form-item>
        </el-row>
        <el-row>
          <el-form-item label="备注：" prop="">
            <el-input v-model="form.expandContent.msg" maxlength="500" show-word-limit type="textarea"></el-input>
          </el-form-item>
        </el-row>
      </el-form>
