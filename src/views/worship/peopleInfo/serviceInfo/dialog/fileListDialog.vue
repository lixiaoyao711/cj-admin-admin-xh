  ...
  <div class="workInfoEditDialog">
    <el-dialog title="附件信息" :visible.sync="open" width="1080px" append-to-body @close="cancel">
      <el-form ref="form" :model="form.expandContent" :rules="rules" label-width="140px">
        <el-form-item label="入伍材料" prop="">
          <imageUpload v-model="form.expandContent.enlistmentMaterialsUrl" :fileSize="20"></imageUpload>
        </el-form-item>
        <el-form-item label="奖惩材料" prop="">
          <imageUpload v-model="form.expandContent.rewardPunishmentUrl" :fileSize="20"></imageUpload>
        </el-form-item>
      </el-form>
