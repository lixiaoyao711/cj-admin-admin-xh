        ...
        series: [
          {
            color: '#5B8FF9',
            name: '越级上访',
            data: this.propsData.zjxfbl.map((item) => item.value['越级上访']),
            type: 'bar',
            // 线条宽度
            barWidth: '18',
            // 平均线
...

          {
            color: '#5D7092',
            name: '总上访',
            data: this.propsData.zjxfbl.map((item) => item.value['总上访']),
            type: 'bar',
            // 线条宽度
            barWidth: '18',
            // 平均线
          ...
          },
          {
            color: '#5AD8A6',
            name: '重复上访',
            data: this.propsData.zjxfbl.map((item) => item.value['重复上访']),
            type: 'bar',
            // 线条宽度
            barWidth: '18',
            // 平均线
