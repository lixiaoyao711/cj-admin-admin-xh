  ...
  <div class="indoor">
    ...
    >
      ...
      <el-form-item label="人员类别" prop="personCategory">
        <el-select v-model="queryParams.personCategory" placeholder="请选择人员类别" clearable>
          <el-option
            v-for="dict in dict.type.sys_worship_tuiyijunrenanzhileibie"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <div class="table">
      <div class="table-title-box">
        <div class="title-name">判刑人员列表</div>
      ...
      <el-table v-loading="loading" :data="serviceFamilyList" @selection-change="handleSelectionChange" height="56vh">
        ...
        <el-table-column label="家庭住址" align="center" prop="permanentResidenceAddress" width="240" />
        <el-table-column label="人员类别" align="center" prop="divisionName">
          <template slot-scope="scope">
            <div>
              <div v-if="scope.row.personCategory != null">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200">
          <template slot-scope="scope">
            <el-button size="mini" type="text">
              <router-link :to="`/worship/externalPerson/info/${scope.row.id}`">
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-table v-loading="loading" :data="formTable" height="56vh">
...
import {
  ...
  updateSentenceInfo,
  delSentenceInfo,
} from '@/api/worship/sentenceInfo.js';
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      queryBasicInfoPageList(this.queryParams).then((response) => {
        this.serviceFamilyList = response.rows;
        this.total = response.total;
        this.loading = false;
        this.$emit('getList', this.queryParams.divisionCode);
      });
    },
    ...
    handleUpdate(row) {
      ...
      getSentenceInfo(row.id).then((response) => {
        this.loading = false;
