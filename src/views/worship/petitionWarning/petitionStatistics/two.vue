    ...
    <div class="count-box">
      ...
      <div class="item">
        <el-progress
          ...
          :text-inside="true"
          :stroke-width="20"
          :percentage="parseInt(propsData.stateMap['待处理'] * 100)"
          color="#FF6565"
          :format="format"
        ></el-progress>
        <el-progress
          ...
          :text-inside="true"
          :stroke-width="20"
          :percentage="parseInt(propsData.stateMap['处理中'] * 100)"
          color="#52ACFF"
          :format="format1"
        ></el-progress>
        <el-progress
          ...
          :text-inside="true"
          :stroke-width="20"
          :percentage="parseInt(propsData.stateMap['已结案'] * 100)"
          color="#46E391"
          :format="format2"
        ></el-progress>
      </div>
...
export default {
  ...
  methods: {
    format(percentage) {
      return `待处理${percentage}%`;
    },
    format1(percentage) {
      return `办理中${percentage}%`;
    },
    format2(percentage) {
      return `已结案${percentage}%`;
    },
    format3(percentage) {
      return percentage;
    },
