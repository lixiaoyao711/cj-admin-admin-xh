  ...
  <div class="indoor">
    ...
    <div class="table">
      ...
      <el-table v-loading="loading" :data="serviceFamilyList" @selection-change="handleSelectionChange" height="56vh">
        ...
        <el-table-column label="登记人" align="center" prop="reportUser" />

        <el-table-column label="信息等级" align="center" prop="infoUrgencyLevel">
          <template slot-scope="scope">
            <dict-tag :options="dict.type.sys_worship_xfdjqd" :value="scope.row.infoUrgencyLevel" />
          </template>
        </el-table-column>
        ...
        <el-table-column label="审核内容" align="center" prop="approvalContent" />
