<template>
  <div class="app-militaryRest">
    ...
    <div class="table">
      ...
      <el-table v-loading="loading" :data="activityList" @selection-change="handleSelectionChange" height="85%">
    ...
    <el-dialog :title="title" :visible.sync="open" width="45%" append-to-body>
      <el-row class="rows">
        <el-col :span="24" class="alignCenter">
          <el-tag type="info" class="info-tag"><dict-tag :options="dict.type.sys_worship_activity_fy" :value="form.activityType"/></el-tag>
          <span class="name">{{ form.activityTitle }}</span> 
        </el-col>
        <el-col :span="12">
          组织单位：{{ form.divisionName }}
        </el-col>
        <el-col :span="12">参加人数：{{ form.numOfParticipants }}人</el-col>
        <el-col :span="12">
          活动日期：{{ form.activityTime }}
        </el-col>
        <el-col :span="24">
          <div>活动地址：</div>
